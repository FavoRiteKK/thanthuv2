var nptr = Module.findExportByName('libcocos2dluar.so', "_Z16tj_xxtea_decryptPhjS_jPj");
function fn() {
    ...
    Interceptor.attach(nptr, {
      onEnter: function(args) {
        ...
        // send({ path: args[3].readCString() /* filename */, dump: code });
			...
			//-======================
			// try {
				// var code = retval.readUtf8String(this.u.readInt());//retval.readByteArray(this.u.readInt()); // file content
